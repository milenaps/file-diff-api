...
public interface FileDiffService {
     ...
     */
    Bucket uploadLeft(String id, byte[] data) throws FileDiffAlreadyExistsException;
     ...
     * @throws FileDiffAlreadyExistsException
     */
    Bucket uploadRight(String id, byte[] data) throws FileDiffAlreadyExistsException;
